...
function resetForm(){ q("form").reset(); q("maintId").value=""; q("deviceId").value=""; if(q("deviceSearch")){ q("deviceSearch").value=""; q("deviceSearch").disabled=false; } q("formTitle").textContent="Phiếu bảo dưỡng"; q("saveMaintBtn").textContent="Lưu bảo dưỡng"; q("fileHint").textContent="Chọn tệp nếu có biên bản hoặc ảnh hiện trạng."; fillMaintDeviceInfo(); }
